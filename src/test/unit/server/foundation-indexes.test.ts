  ...
  it("creates the indexes used by store, network and settings queries", async () => {
    ...
    expect(createdNames).toEqual(
      expect.arrayContaining([
        ...
        "daily_import_jobs_scope_fingerprint_coverage_unique",
        "daily_import_jobs_scope_status_created",
        "daily_sales_facts_scope_product_date_active_unique",
        "daily_sales_facts_scope_product_date_version_unique",
        "daily_sales_facts_scope_date_active",
        "daily_sales_facts_scope_week_active",
        "daily_sales_facts_import_active",
        "store_settings_scope_unique",
        "store_configuration_commands_scope_key_unique",
        "promotion_context_scope_date_recorded",
        "promotion_context_scope_product_date",
