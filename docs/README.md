...
- [Socle hors ligne et documents — périmètres et gates](../implementation/31_OFFLINE_AND_DOCUMENT_FOUNDATION.md)
- [Synchronisation des stocks TECH-03 — limites de validation](../implementation/35_TECH_03_INVENTORY_SYNCHRONIZATION.md)
