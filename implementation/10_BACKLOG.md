...
| V7-01 | Deferred architecture | Unified offline-first refactoring with Serwist | P3 / deferred | Existing TECH-01/03, PILOT-01 feedback, explicit reprioritization |

V7-01 is a future planning epic, **not a reopening of the offline extension
freeze** or a prerequisite to current TECH-05/06 and V4/V5 work. Its phased scope,
online-only exceptions and acceptance gates are recorded in
